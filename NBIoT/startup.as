	...
	; Compiler options:
	;
	; -oBC28.cof -mBC28.map --summary=default,-psect,-class,+mem,-hex \
	; --output=default,-inhx032 Display.p1 Init.p1 Main.p1 Function.p1 \
	; TestProc.p1 afx.p1 ATCommand.p1 DS18x20.p1 OneWire.p1 TCN75.p1 \
	; Uart.p1 Verify.p1 SimI2C.p1 --chip=16F1937 -P \
	...
	; --debugger=pickit3 --addrqual=ignore -DSim800C -g --asmlist \
