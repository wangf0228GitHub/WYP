...
void SX126xConfigureRxDuty(uint32_t rxTime, uint32_t sleepTime)
{
	SX126xSetDioIrqParams(IRQ_RX_DONE | IRQ_HEADER_ERROR | IRQ_PREAMBLE_DETECTED, IRQ_RX_DONE | IRQ_HEADER_ERROR | IRQ_PREAMBLE_DETECTED,
