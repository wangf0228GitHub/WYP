...
#include "sx126x.h"
#define RADIO_SPI_ID	SPI2

#define RADIO_NSS_Pin GPIO_Pin_7
#define RADIO_NSS_GPIO_Port GPIOD

#define RADIO_BUSY_Pin GPIO_Pin_1
#define RADIO_BUSY_GPIO_Port GPIOH

#define RADIO_DIO1_Pin GPIO_Pin_2
#define RADIO_DIO1_GPIO_Port GPIOH

#define RADIO_RESET_Pin GPIO_Pin_0
#define RADIO_RESET_GPIO_Port GPIOH

#define RADIO_AntPow_Pin GPIO_Pin_6
#define RADIO_AntPow_GPIO_Port GPIOG

#define RADIO_MOSI_Pin GPIO_Pin_2
#define RADIO_MOSI_GPIO_Port GPIOI

#define RADIO_MISO_Pin GPIO_Pin_3
#define RADIO_MISO_GPIO_Port GPIOI

#define RADIO_SCLK_Pin GPIO_Pin_1
#define RADIO_SCLK_GPIO_Port GPIOI
/*!
